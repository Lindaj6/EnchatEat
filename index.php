...
?>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="cat-food.png" class="d-block w-60 h-70" alt="...">
        </div>
        <div class="carousel-item">
          <img src="Petfood.jpg" class="d-block w-60 h-70" alt="...">
        </div>
        <div class="carousel-item">
          <img src="fish-food-1204648_1920.jpg" class="d-block w-60 h-70" alt="...">
        </div>
      </div>
  ...
  <div class="container-fluid">
      <div class="row">
        <div class="col">
          <h3 class="fw-bolder">Before</h3>
          <img src="https://th.bing.com/th/id/OIP.zYu2Unw10cVrOPFuwKmVlgHaJZ?w=145&h=184&c=7&r=0&o=5&pid=1.7" class="img-size" alt="flyp.1">
        </div>
        <div class="col">
          <h3 class="fw-bolder">Product</h3>
          <img src="pigfood.jfif" class="img-size" alt="pf">
      </div>
        <div class="col">
          <img src="https://th.bing.com/th/id/OIP.xTV1mZLaIOihbsm6WXEnqAHaHa?w=152&h=180&c=7&r=0&o=5&pid=1.7" class="test" alt="dog.1">
        </div>
        <div class="col">
          <h3 class="fw-bolder">After</h3>
          <img src="flying.jpg" class="img-size" alt="flyp.2">
        </div>
</div>
<br>
<br>
...
<br>
  ...
  <div class="col">
    <img src="https://petdogowner.com/wp-content/uploads/2021/04/AdobeStock_133322407-scaled.jpeg" class="img-size" alt="dog.1">
  </div>
  <div class="col">
    <img src="https://th.bing.com/th/id/OIP.8pQ1l4_T-M6vkweXkHdMBwHaE7?w=262&h=180&c=7&r=0&o=5&pid=1.7" class="img-size" alt="df">
</div>
<div class="col">
  <img src="https://th.bing.com/th/id/OIP.xTV1mZLaIOihbsm6WXEnqAHaHa?w=152&h=180&c=7&r=0&o=5&pid=1.7" class="test" alt="dog.1">
</div>
  <div class="col">
    <img src="MicrosoftTeams-image.png" class="img-size" alt="dog.2">
  </div>
</div>
<br>
<div class="row">
  <div class="col">
    <img src="fish.jpg" class="img-size" alt="fish.1">
  </div>
  <div class="col">
    <img src="https://th.bing.com/th/id/OIP.LeIzdCTSJI5Ins5pOBzYrgHaHa?w=190&h=190&c=7&r=0&o=5&pid=1.7" class="img-size" alt="ff.1">
  </div>
  <div class="col">
    <img src="https://th.bing.com/th/id/OIP.xTV1mZLaIOihbsm6WXEnqAHaHa?w=152&h=180&c=7&r=0&o=5&pid=1.7" class="test" alt="dog.1">
  </div>
  <div class="col">
    <img src="legs.jpg" class="img-size" alt="fish.2">
  </div>
